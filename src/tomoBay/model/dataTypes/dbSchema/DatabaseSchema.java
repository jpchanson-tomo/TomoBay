...
public enum DatabaseSchema
{
	...
	private static final Map<DatabaseSchema, String> toType_M = new HashMap<DatabaseSchema,String>()
	{{
		put(DatabaseSchema.BUY_BUYER_ID, "String");
		put(DatabaseSchema.BUY_CITY, "String");
		put(DatabaseSchema.BUY_COUNTY, "String");
		put(DatabaseSchema.BUY_EMAIL, "String");
		put(DatabaseSchema.BUY_NAME, "String");
//		put();
//		put();
//		put();
//		put();
...
//		put();
	 ...
	 * @return
	 */
	public static String typeOf(DatabaseSchema field)
	{return DatabaseSchema.toType_M.get(field);}
}
