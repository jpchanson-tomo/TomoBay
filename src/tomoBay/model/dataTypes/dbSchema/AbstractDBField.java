 ...
 *
 */
public interface AbstractDBField
{
	/**
	 * returns the type of this particular Database field as a string
	 * @return String containing the type of this field as defined by a constant in the DBType Class
	 */
	public abstract String type();
	
	/**
	 * the size of the data base field, this reflects the size allocated for this particular field in 
	 * the database implementation 
	 * @return int representing the number of characters/digits allocated to this particular field
	 */
