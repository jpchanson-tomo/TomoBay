 ...
 *
 */
public  final class UpdateItemError implements AbstractDBQuery
{
	...
	public List<String[]> execute(String[] parameter) throws SQLException
	{
		...
		this.statement_M.setString(3, parameter[2]);
		this.statement_M.setLong(4, Long.parseLong(parameter[3]));	//itemID
