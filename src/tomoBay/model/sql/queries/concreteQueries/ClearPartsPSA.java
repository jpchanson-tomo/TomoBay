...
/**
 * This class represents a query that clears the required field of the PSA specific parts 
 * table in the database. 
 * @author Jan P.C. Hanson
 *
 */
public  final class ClearPartsPSA implements AbstractDBQuery
{
