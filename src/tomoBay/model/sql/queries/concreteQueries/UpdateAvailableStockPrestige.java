 ...
 *
 */
public  final class UpdateAvailableStockPrestige implements AbstractDBQuery
{
	...
	/**SQL query string**/
	private String query ="UPDATE parts_prestige SET available=? WHERE partNo=?;";
	 ...
	 * default constructor
	 */
	public UpdateAvailableStockPrestige()
	{super();}
	 ...
	 * - col1 = parts_prestige.available:int(6)
	 * - col2 = parts_prestige.partNo:varchar(50)
