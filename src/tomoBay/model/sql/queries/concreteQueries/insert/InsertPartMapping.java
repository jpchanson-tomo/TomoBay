 ...
 *
 */
public final class InsertPartMapping extends AbstractInsertQuery
{
	/**SQL query string**/
	private String query ="INSERT IGNORE INTO item_part_mapping (itemID, partID) "
						+ "VALUES "
							+ "("
								+ "?, "
								+ "("
									+ "SELECT id FROM parts "
									+ "WHERE partNo=? AND description=? AND brand=? "
								+ ") "
							+ ") ;";
	 ...
	 * - col1 = itemID:BIGINT(13)
	 * - col2 = partNo:VARCHAR(17) 
	 * - col3 = description:VARCHAR(55)
	...
	public List<String[]> execute(String[] parameter) throws SQLException
	{
		...
		this.statement_M.setString(1, parameter[0]); 	//itemId
		this.statement_M.setString(2, parameter[1]);	//partNo
		this.statement_M.setString(3, parameter[2]);	//description
