 ...
 * ford specific parts table of the database, given a particular part number.
 * @author Jan P.C. Hanson
 *
 */
public  final class SelectFordStockReqByPart implements AbstractDBQuery
{
	...
	/**SQL query string**/
	private String query ="SELECT partNo, required FROM parts_ford WHERE partNo=?;";
	//
	/**
	 * default constructor
	 */
	public SelectFordStockReqByPart()
	{super();}
	 ...
	 * @return arameter NotUsed NOT USED 
