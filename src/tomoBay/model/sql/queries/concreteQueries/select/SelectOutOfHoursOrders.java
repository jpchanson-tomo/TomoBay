 ...
 *
 */
public  final class SelectOutOfHoursOrders extends AbstractSelectQueryWithParams
{
	/**SQL query string**/
	...
	public List<String[]> execute(String[] startAndEnd) throws SQLException
	{
		...
		super.statement_M.setDate(1, Date.valueOf(startAndEnd[0]));
		super.statement_M.setDate(2, Date.valueOf(startAndEnd[1]));
