 ...
 *
 */
public  final class SelectEbayItemsError extends AbstractSelectQueryNoParams
{
	/**SQL query string**/
	private String query ="SELECT * FROM ebay_items WHERE notes LIKE '%ERROR%';";
	//
	/**
	 * default constructor
	 */
	 ...
	 * represents a row of the ebay_items database table and each element of the String[] represents a field.
	 * 
