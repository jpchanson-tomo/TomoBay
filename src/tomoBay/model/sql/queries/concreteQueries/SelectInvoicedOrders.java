 ...
 *
 */
public  final class SelectInvoicedOrders implements AbstractDBQuery
{
	...
	/**SQL query string**/
	private static final String query = "SELECT * FROM ebay_orders WHERE invoiced = 1 ORDER BY createdTime DESC;";
