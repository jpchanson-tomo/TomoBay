...
/**
 * this class represents a query that updates the ford specific parts table with required stock
 * information.
 * @author Jan P.C. Hanson
 *
 */
public  final class UpdateFordStockReq implements AbstractDBQuery
{
	 ...
	 * This query only requires two bits of data so any element above the 1st will be ignored.
	 * - col1 = required:int(6)
