...
/**
 * This class represents a query that clears the required field of the ford specific parts 
 * table in the database. 
 * @author Jan P.C. Hanson
 *
 */
public final class ClearPartsFord implements AbstractDBQuery
{
