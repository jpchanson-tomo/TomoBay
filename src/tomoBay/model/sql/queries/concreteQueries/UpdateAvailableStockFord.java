 ...
 * ford specific parts table with available stock data based on partNo. The second query updates
 * the items table with a note (assuming there is an error) given a particular item id.
 * @author Jan P.C. Hanson
 *
 */
public  final class UpdateAvailableStockFord implements AbstractDBQuery
{
	 ...
	 * - col1 = parts_ford.available:int(6)
	 * - col2 = parts_ford.partNo:varchar(50)
