...
/**
 * This class represents a query that inserts required stock level data into the ford specific
 * parts table of the database.
 * @author Jan P.C. Hanson
 *
 */
public  final class InsertFordStockReq implements AbstractDBQuery
{
