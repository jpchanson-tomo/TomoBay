 ...
 *
 */
public abstract class AbstractSelectQueryNoParams extends AbstractDBQuery
{

	/**
	 * default ctor
	 */
	public AbstractSelectQueryNoParams()
	{super();}
	 ...
	 */
	@Override
	public abstract List<String[]> execute(String[] NOT_USED) throws SQLException;
	 ...
	 */
	protected abstract List<String[]> format(ResultSet resultSet)throws SQLException;
