...
import tomoBay.model.sql.queries.concreteQueries.UpdateFordStockReq;

/**
 * creates an UpdateFordStockReq query object
 * @see {@link tomoBay.model.sql.queries.concreteQueries.UpdateFordStockReq}
 * @author Jan P.C. Hanson
 *
 */
public final class UpdateFordStockReqFactory implements AbstractQueryFactory
{
	/**
	 * default ctor
	 */
	public UpdateFordStockReqFactory()
	{super();}
