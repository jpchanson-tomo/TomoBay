...
import tomoBay.model.sql.queries.concreteQueries.InsertFordStockReq;

/**
 * Creates an InsertFordStockReq query object
 * @see {@link tomoBay.model.sql.queries.concreteQueries.InsertFordStockReq}
 * @author Jan P.C. Hanson
 *
 */
public final class InsertFordStockReqFactory implements AbstractQueryFactory
{
	/**
	 * default ctor
	 */
	public InsertFordStockReqFactory()
	{super();}
