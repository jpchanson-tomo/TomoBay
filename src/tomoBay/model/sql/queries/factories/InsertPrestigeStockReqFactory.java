...
import tomoBay.model.sql.queries.concreteQueries.InsertPrestigeStockReq;

/**
 * creates an InsertPrestigeStockReq query object
...
public class InsertPrestigeStockReqFactory implements AbstractQueryFactory
{
	 ...
	 * default ctor
	 */
	public InsertPrestigeStockReqFactory()
	{super();}
	...
	{
		return new InsertPrestigeStockReq();
	}
