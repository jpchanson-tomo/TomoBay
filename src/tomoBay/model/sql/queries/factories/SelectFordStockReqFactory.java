...
import tomoBay.model.sql.queries.concreteQueries.SelectFordStockReqByPart;

/**
 * creates a SelectFordStockReqByPart query object
...
public final class SelectFordStockReqFactory implements AbstractQueryFactory
{
	 ...
	 * default ctor
	 */
	public SelectFordStockReqFactory()
	{super();}
	...
	{
		return new SelectFordStockReqByPart();
	}
