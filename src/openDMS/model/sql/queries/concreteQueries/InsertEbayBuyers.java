...
public class InsertEbayBuyers implements AbstractDBQuery
{
	 ...
	 * Orders Table only has 3 columns so any element above the 2nd element will be ignored.
	 * col1 =buyerID:varchar(40), col2=name:varchar(45), col3=address:varchar(150),  
